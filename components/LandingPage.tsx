...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050510] text-white font-sans selection:bg-indigo-500/30 overflow-hidden relative">
      ...
      {/* Free Tools Section */}
      <section className="py-24 px-6 relative z-10 bg-slate-900/30 border-y border-white/5">
        <div className="max-w-6xl mx-auto">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="inline-block px-4 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-sm font-semibold mb-4">
              Free AI Tools
            </span>
            <h2 className="text-3xl sm:text-5xl font-bold text-white mb-6">
              Try Our <span className="text-indigo-400">Free Analyzers</span>
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto text-lg">
              Experience the power of our AI technology with these free tools.
              No signup required.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <motion.a
              ...
              whileHover={{ y: -5 }}
              className="group block bg-slate-950 border border-slate-800 hover:border-indigo-500/50 rounded-2xl p-6 transition-all"
            >
              ...
              <p className="text-slate-400 mb-4">
                Instant AI analysis to determine your face shape (Oval, Round,
                Square, etc.) with personalized styling tips.
              </p>
            ...
            {/* Coming Soon Tools */}
            <div className="group bg-slate-950/50 border border-slate-800/50 rounded-2xl p-6 opacity-60">
              ...
              <p className="text-slate-500 mb-4">
                Calculate your facial proportions and golden ratio score.
              </p>
              <span className="inline-block px-2 py-1 bg-slate-800 rounded text-xs text-slate-400">
                Coming Soon
              </span>
            </div>
            ...
            <div className="group bg-slate-950/50 border border-slate-800/50 rounded-2xl p-6 opacity-60">
              ...
              <p className="text-slate-500 mb-4">
                Determine your eye shape and tilt for the best aesthetics.
              </p>
              <span className="inline-block px-2 py-1 bg-slate-800 rounded text-xs text-slate-400">
                Coming Soon
              </span>
